...
/*$totalClientes=count(getItensTable($mysql_conn,"clientes"));
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?=$totalClientes?></div>
                                    <div>Clientes</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
								...
								{ 
								?>
								  <a href="../os/os.php" class="list-group-item">
